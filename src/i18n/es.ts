...
export const es = {
  meta: {
    title: 'Ronda Segura — Evidencia real de las rondas de tus guardias',
    description:
  ...
  hero: {
    ...
    subtitle:
      'Ronda Segura combina el escaneo del QR pegado en el punto con la ' +
  ...
  caps: {
    title: 'Lo que hace distinto a Ronda Segura',
    items: [
      {
  ...
  fraud: {
    ...
    footnote:
      ...
      'con una app—, Ronda Segura lo detecta y tampoco activa la marca.',
  },

  finalCta: {
    title: '¿Te sirve algo así?',
    body:
      'Ronda Segura está en desarrollo. Si administras guardias o rondas, ' +
  ...
  footer: {
    tagline: 'Ronda Segura es un producto de Orbital Studio.',
